...
| 11 | Build interactive TUI search flow | feat | 05, 07, 10 | [x] | Make `seekr` launch a responsive ratatui interface with fuzzy search, live results, navigation, and command preview. |
| 12 | Implement copy, insert, and rerun reuse actions | feat | 08, 11 | [x] | Add safe reuse actions for copying, inserting into the prompt for review, and explicitly rerunning selected commands. |
...
| 14 | Add end-to-end smoke coverage and setup documentation | feat | 01, 06, 08, 09, 11, 12, 13 | [x] | Add scripted smoke coverage and concise setup documentation for the MVP workflows. |
